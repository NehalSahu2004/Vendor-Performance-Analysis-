...
if selected_model == "Freight Cost Prediction":
    ...
    **Objective:**
    ...
    with st.form("freight_form"):
        ...
        with col2:
            dollars = st.number_input("Dollars",
                                      min_values=1.0,
                                      value=18500.0)
            submit_freight = st.form_submit_button(label="Predict Freight Cost")
        ...
        if submit_freight:
            ...
            st.success("Predicted completed successfully")
    ...
    **Objective:**
    ...
    if submit_flag:
        input_data = {
            ...
            "total_invoice_dollars": [total_invoice_dollars],
        }
